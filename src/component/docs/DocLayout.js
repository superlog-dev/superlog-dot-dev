  ...
  return (
    <div className="dark">
      ...
      <div className="flex justify-center max-w-6xl mx-auto bg-0">
        ...
        <div className="flex flex-col flex-1 px-4 py-8 overflow-scroll prose max-w-none bg-0 dark:prose-invert prose-h1:text-1-on-1 prose-h2:text-1-on-1 prose-h2:text-3xl">
          <div className="">
            {children}
            <DocPrevNext />
          </div>
