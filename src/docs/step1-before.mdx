...
Because we want every commit to be mergable and reviewable through pull request:

- Superlog enforce one commit per branch

To make sure you have one commit per branch:

- Superlog enforce creating a new branch whenever you make a commit
